...
urlpatterns = [
    ...
    url(r'^settings/change-name$', settings_name_loader, name="settings_name_loader"),
    url(r'^settings/change-password$', settings_password_loader, name="settings_password_loader"),
    url(r'^settings/change-email$', settings_email_loader, name="settings_email_loader"),
    url(r'^settings/change-tz$', settings_tz_loader, name="settings_tz_loader"),
    url(r'^settings/settingsavename', processor_settings_name, name="processor_settings_name"),
    url(r'^settings/settingsaveemail', processor_settings_email, name="processor_settings_email"),
    url(r'^settings/settingsavetz', processor_settings_tz, name="processor_settings_tz"),
    url(r'^settings/settingsavepassword', processor_settings_password, name="processor_settings_password"),
